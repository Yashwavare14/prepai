...
export default function StudentLayout({ children }) {
  ...
  const navLinks = [
    ...
    { href: '/student/onboarding', label: '👤 Profile & Goals' },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            <Link href="/student/dashboard" className="flex items-center gap-2 group">
              ...
              <div>
                ...
                <span className="ml-2 text-xs font-semibold uppercase px-2 py-0.5 rounded bg-emerald-100 text-emerald-800">
                  Student
                </span>
              </div>
            </Link>
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="hidden sm:inline-block text-xs font-semibold text-slate-500 hover:text-blue-600 transition-colors"
            >
              Admin Portal →
            </Link>
