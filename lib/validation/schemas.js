...
// --- Student profile onboarding / update schema ---
export const studentProfileSchema = z.object({
  name:                 z.string().min(1, "Name is required").max(255),
  email:                z.string().email().optional(),
  phone:                z.string().max(20).optional().nullable(),
  targetExams:          z.array(z.string()).min(1, "Select at least one target exam"),
  targetYear:           z.string().max(10).optional().nullable(),
  preferredLanguage:    z.string().max(10).default("en"),
  dailyGoalQuestions:   z.number().int().min(5).max(200).default(20),
  
  // 10th
  tenthPercentage:      z.string().max(10).optional().nullable(),
  tenthSchool:          z.string().max(255).optional().nullable(),
  tenthBoard:           z.string().max(50).optional().nullable(),
  tenthPassingYear:     z.string().max(4).optional().nullable(),

  // 12th
  twelfthPercentage:    z.string().max(10).optional().nullable(),
  twelfthSchool:        z.string().max(255).optional().nullable(),
  twelfthBoard:         z.string().max(50).optional().nullable(),
  twelfthStream:        z.string().max(50).optional().nullable(),
  twelfthPassingYear:   z.string().max(4).optional().nullable(),

  // Graduation
  graduationDegree:     z.string().max(100).optional().nullable(),
  graduationCollege:    z.string().max(255).optional().nullable(),
  graduationScore:      z.string().max(20).optional().nullable(),
  graduationStatus:     z.string().max(20).optional().nullable(),
  graduationPassingYear: z.string().max(4).optional().nullable(),

  extraAcademicData:    z.record(z.string(), z.any()).optional().nullable(),
